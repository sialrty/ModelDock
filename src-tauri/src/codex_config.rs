...
/// provider is routed through ModelDock.  A dedicated id is an ownership
...
pub fn apply_codex_official_proxy_route(
    ...
    // Clean only ModelDock's placeholder from every stale provider table. Real
...
/// Whether a live Codex config is the official route projected by ModelDock.
...
/// Remove only the official takeover route owned by ModelDock. This is a
